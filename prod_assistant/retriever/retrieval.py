...
class Retriever:
    ...
    def load_retriever(self):
        # Implement retriever loading logic here
        if not self.vstore: 
        ...
        print("Retreiver loaded successfully")
    ...
    def call_retriever(self, query: str) -> str:
...
if __name__ == "__main__": 
    ...
    retriever_docs = retriever_obj.call_retriever(user_query)
